...
class AstralEnTranslationProvider(
    ...
    override fun generateTranslations(lookup: HolderLookup.Provider, gen: TranslationBuilder) {
        ...
        gen.add("kosmogliph.tooltip.astral_arsenal.endurance.desc",
            "Reduces damage from melee sources by 65%"
        )
        gen.add("kosmogliph.tooltip.astral_arsenal.capacitance.desc",
            "Reduces damage from electricity and light by 80% and occasionally causes a strike on attackers."
        )
        gen.add("kosmogliph.tooltip.astral_arsenal.thermal.desc",
            "Reduces damage from ice and frost by 80% and prevents slowness and frost from effecting you"
        )
        gen.add("kosmogliph.tooltip.astral_arsenal.heavy.desc",
            "Reduces damage from explosions by 90%"
        )
        gen.add("kosmogliph.tooltip.astral_arsenal.reflective.desc",
            "Reduces damage from projectiles by 50% and has a 70% chance to fling them back entirely"
        )

        //weapons
        gen.add("kosmogliph.tooltip.astral_arsenal.astral_strike.desc",
            "Every third hit, strike the target with an astral beam of light for 5 damage"
        )
        gen.add("kosmogliph.tooltip.astral_arsenal.freeze.desc",
            "Entities hit are frozen for a short time. On kill, the entity will release ice shards"
        )
        gen.add("kosmogliph.tooltip.astral_arsenal.flame_burst.desc",
            "Entities hit are set alight for a short time. On kill, the entity will release fire balls"
        )
        gen.add("kosmogliph.tooltip.astral_arsenal.astral_slash.desc",
            "Right click to send an astral blade forward for 5 magic damage, x2.5 on non-players. 10 second cooldown"
        )
        gen.add("kosmogliph.tooltip.astral_arsenal.deep_wounds.desc",
        ...
        gen.add("kosmogliph.tooltip.astral_arsenal.trident_reduce.desc",
            "On hit, give 1 level of reduce. On ranged hit, give 6. Reduce causes entities to take 5% more damage per level"
        )
        gen.add("kosmogliph.tooltip.astral_arsenal.trident_bleed.desc",
            "on hit and ranged hit, give 1 level of bleed. Bleed causes entities to take 1 damage per second, increased by 0.25 per level"
        )
        gen.add("kosmogliph.tooltip.astral_arsenal.cannonball.desc",
        ...
        gen.add("kosmogliph.tooltip.astral_arsenal.shotgun.desc",
            "shoots 5 projectiles instead of one in a spread. Increases with multishot."
        )
        gen.add("kosmogliph.tooltip.astral_arsenal.orbital.desc",
        ...
        gen.add("kosmogliph.tooltip.astral_arsenal.devastate.desc",
        ...
        gen.add("kosmogliph.tooltip.astral_arsenal.lock_off.desc",
        ...
        gen.add("kosmogliph.tooltip.astral_arsenal.time_bomb.desc",
        ...
        gen.add("kosmogliph.tooltip.astral_arsenal.slam.desc",
            "Crouching mid-air lets you slam, taking half the fall damage. Gives a short-lasting jump-boost when slamming, letting you jump higher then you fell from"
        )
        gen.add("kosmogliph.tooltip.astral_arsenal.ankle_guard.desc",
            "Prevents fall damage from taking you to less then 1hp"
        )
        gen.add("kosmogliph.tooltip.astral_arsenal.dash.desc",
            "Pressing a keybind[default R] lets you dash forward. Dashes recharge over a second. You can hold up to 3"
        )
        gen.add("kosmogliph.tooltip.astral_arsenal.dodge.desc",
        ...
        gen.add("kosmogliph.tooltip.astral_arsenal.jump.desc",
            "Gives you 3 mid-air jumps. Jumps start recharging when you hit the ground, each recharge in a second"
        )
        gen.add("kosmogliph.tooltip.astral_arsenal.step_up.desc",
            "Lets you step up 1.5 blocks"
        )
        gen.add("kosmogliph.tooltip.astral_arsenal.parry.desc",
            "For the first quater second of holding your shield up, you can parry. Parrying projectiles launches them back, causing them to explode. Parrying melee attacks causes double the damage to hit the attacker"
        )
        gen.add("kosmogliph.tooltip.astral_arsenal.frost_thorns.desc",
            "When the shield is hit, release a set of frost thorns towards the attacker"
        )

        //tools
        gen.add("kosmogliph.tooltip.astral_arsenal.smelter.desc",
            "Automatically smelts blocks broken and mob drops"
        )
        gen.add("kosmogliph.tooltip.astral_arsenal.hammer.desc",
            "Allows you to mine a 3x3 area"
        )
        gen.add("kosmogliph.tooltip.astral_arsenal.vein_miner.desc",
            "Allows you to mine a full vein of ores"
        )
        gen.add("kosmogliph.tooltip.astral_arsenal.reaper.desc",
        ...
        gen.add("kosmogliph.tooltip.astral_arsenal.explosive_beam.desc",
            "Fires an explosive beam, causing the first entity it hits to explode, or the ground if it misses. 30 second cooldown"
        )
        gen.add("kosmogliph.tooltip.astral_arsenal.ray_of_frost.desc",
            "Fires a ray of frost, dealing 7.5 ice damage and freezing entities. 30 second cooldown"
        )
        gen.add("kosmogliph.tooltip.astral_arsenal.flame_thrower.desc",
            "Fires a constant stream of fire, dealing 1 damage per tick and setting entities on fire"
        )
        gen.add("kosmogliph.tooltip.astral_arsenal.rancid_brew.desc",
        ...
        gen.add("kosmogliph.tooltip.astral_arsenal.snipe.desc",
        ...
        gen.add("kosmogliph.tooltip.astral_arsenal.ricochet.desc",
