...
class AstralItemTagProvider(
    ...
    private fun kosmogliphTags() {
        ...
        getOrCreateTagBuilder(AstralItemTags.SUPPORTS_ANTIPHASE).forceAddTag(ConventionalItemTags.BOW_TOOLS)
        getOrCreateTagBuilder(AstralItemTags.SUPPORTS_MAGNETIC).forceAddTag(ConventionalItemTags.BOW_TOOLS)
        getOrCreateTagBuilder(AstralItemTags.SUPPORTS_CONDUCTIVE).forceAddTag(ConventionalItemTags.BOW_TOOLS)
        ...
        getOrCreateTagBuilder(AstralItemTags.SUPPORTS_SCORCH_PROOF).forceAddTag(ItemTags.CHEST_ARMOR).add(Items.ELYTRA)
        getOrCreateTagBuilder(AstralItemTags.SUPPORTS_ANTIDOTE).forceAddTag(ItemTags.CHEST_ARMOR).add(Items.ELYTRA)
        getOrCreateTagBuilder(AstralItemTags.SUPPORTS_ENDURANCE).forceAddTag(ItemTags.CHEST_ARMOR).add(Items.ELYTRA)
        getOrCreateTagBuilder(AstralItemTags.SUPPORTS_CAPACITANCE).forceAddTag(ItemTags.CHEST_ARMOR).add(Items.ELYTRA)
        getOrCreateTagBuilder(AstralItemTags.SUPPORTS_THERMAL).forceAddTag(ItemTags.CHEST_ARMOR).add(Items.ELYTRA)
        getOrCreateTagBuilder(AstralItemTags.SUPPORTS_HEAVY).forceAddTag(ItemTags.CHEST_ARMOR).add(Items.ELYTRA)
        getOrCreateTagBuilder(AstralItemTags.SUPPORTS_REFLECTIVE).forceAddTag(ItemTags.CHEST_ARMOR).add(Items.ELYTRA)
        ...
        getOrCreateTagBuilder(AstralItemTags.SUPPORTS_KOSMOGLIPHS)
            ...
            .forceAddTag(AstralItemTags.SUPPORTS_ANTIPHASE)
            .forceAddTag(AstralItemTags.SUPPORTS_MAGNETIC)
            .forceAddTag(AstralItemTags.SUPPORTS_CONDUCTIVE)
