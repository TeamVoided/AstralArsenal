...
class BoomEntity : ThrownItemEntity {
    ...
    constructor(entityType: EntityType<out BoomEntity?>?, world: World?) :
            super(entityType as EntityType<out ThrownItemEntity?>?, world)

    constructor(world: World?, owner: LivingEntity?) :
            super(AstralEntities.BOOM_ENTITY as EntityType<out ThrownItemEntity?>, owner, world)

    constructor(world: World?, x: Double, y: Double, z: Double) :
            super(AstralEntities.BOOM_ENTITY as EntityType<out ThrownItemEntity?>, x, y, z, world)
