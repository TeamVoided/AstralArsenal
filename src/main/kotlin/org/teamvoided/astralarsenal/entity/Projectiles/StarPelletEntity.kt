...
//class StarPelletEntity : PersistentProjectileEntity {
//
//    constructor(entityType: EntityType<out StarPelletEntity>, world: World) : super(entityType, world)
//
//    constructor(world: World, owner: LivingEntity) : super(
//        AstralEntities.NAIL_ENTITY, owner, world, Items.ARROW.defaultStack, AstralItems.STARSCATTER.defaultStack
//    )
//
//    constructor(x: Double, y: Double, z: Double, world: World) : super(
//        AstralEntities.NAIL_ENTITY, x, y, z, world, Items.ARROW.defaultStack, AstralItems.STARSCATTER.defaultStack
//    )
//
//    var nailType
