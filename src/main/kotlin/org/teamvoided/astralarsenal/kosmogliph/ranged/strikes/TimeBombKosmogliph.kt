...
class TimeBombKosmogliph(
    ...
    override fun preUse(world: World, player: PlayerEntity, hand: Hand) {
        ...
        if (fireBall) {
            ...
            snowballEntity.innerColour = 0x00b8860b
            snowballEntity.outerColour = 0x00560319
            ...
            if (player.getStackInHand(hand).hasMultiShot()) {
                ...
                snowballEntity2.innerColour = 0x00b8860b
                snowballEntity2.outerColour = 0x00560319
                ...
                snowballEntity3.innerColour = 0x00b8860b
                snowballEntity3.outerColour = 0x00560319
